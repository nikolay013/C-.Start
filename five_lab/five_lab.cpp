...
double lev_pryam(double (*ptr)(double),float leftbord, float rightbord,double eps);
double simpson(double(*ptr)(double), float leftbord, float rightbord, double eps);
		...
		switch (choice)
		{
			...
			case 1:
			{
				...
				switch (method)
				{
					...
					ptr = &function1;
					double inthegral = lev_pryam(ptr, left_border, right_border, epsilon);
					...
					double(*ptr)(double) = NULL;
					ptr = &function1;
					double inthegral = simpson(ptr, left_border, right_border, epsilon);
					cout << "Inthegral is: " << inthegral << " = " << 0.52507329 << '\n';
					break;
					}
